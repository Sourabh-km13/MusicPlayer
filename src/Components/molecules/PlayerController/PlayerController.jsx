...
export default function PlayerController(
    ...
    return(
        ...
        >
            ...
            />
            <div
            className="flex justify-center items-center space-x-4 py-2 px-16 text-gray-400 w-fit"
            >
                <button
...

                {
                        ...
                        onClick={()=>setPlayerstate((prevstate)=>({...prevstate,playing:false}))}
                        >
                        <MdOutlinePauseCircleFilled/>
                        </button>:
                        <button className="text-4xl text-white"
                        onClick={()=>setPlayerstate((prevstate)=>({...prevstate,playing:true}))}
                        >
                            <MdPlayCircleFilled/>
            ...
            <div className="flex items-center justify-center space-x-2 text-xs text-gray-400 py-2">
                    <div className="text-left">
                        {timeFormatter(playerstate.seek)}
                    </div>
                    ...
                    <div>
                        {timeFormatter(playerstate.duration) }
                    </div>
            </div>
